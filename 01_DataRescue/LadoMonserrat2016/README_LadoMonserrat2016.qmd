---
title: "Data Rescue: Lado-Monserrat 2016"
format:
  html:
    toc: true
...
bibliography:
  - LadoMonserrat2016_Methods.bib #contains the citations in the methods section
  - LadoMonserrat2016.bib #contains citation for the data source, generally a single citation of the primary paper
...
timelog:
  ...
  - activity:
      description: began data rescue plan and created github issue.
      who: laylakalandjian
      start: 2026-09-04 T1600
      duration: PT60M
  - activity: 
      description: finished data rescue plan and transcribed half of methods section.
      who: laylakalandjian
      start: 2026-09-05 T1645
      duration: PT45M
  - activity: 
      description: finished methods section transcription.
      who: laylakalandjian 
      start: 2026-09-08 T1045
      duration: PT45M
...
methods.file <- "LadoMonserrat2016_Methods.md"
tableN.file <- 'LadoMonserrat2016_TableN.csv'
figureM.file <- 'LadoMonserrat2016_FigureM.csv'

# Bibliography files
primaryCitation.file <- 'LadoMonserrat2016.bib'
methodsCitation.file <- 'LadoMonserrat2016_Methods.bib'
...
Lado-Monserrat, L., Lidón, A. & Bautista, I. Erratum to: Litterfall, litter decomposition and associated nutrient fluxes in Pinus halepensis: influence of tree removal intensity in a Mediterranean forest. Eur J Forest Res 135, 203–214 (2016). https://doi.org/10.1007/s10342-015-0923-x

For the discussion of this data rescue see the Github issue: https://github.com/ktoddbrown/SoilDRaH/issues/#307.

LadoMonserrat2016 primarily measures the effects on litterfall, litter decomposition, and nutrient fluxes when trees in an Aleppo pine forest underwent four levels of silvicultural treatments.
This is done to investigate the effectiveness of these treatments to increase species richness and fire/pest resistance in sustainable forest management.

## Tables and figures

- Table 
  1) Soil properties in three study blocks, including depth, pH, and nutrients.
  2) Characterization of the shelterwood treatments including basal area and density of stems.
  3) Characterization of litterfall production in the two study years, including fraction of needles, branches, etc.
  4) Results of three-way ANOVA with factors silvicultural treatment, block and year on the nutrient concentration of the needle and miscellaneous litterfall fractions in the summer peaks of production.
  5) Total nutrient return via litterfall in the year 2010 for each silvicultural treatment and the associated regression parameters.
  
- Figure 
  1) Monthly precipitation, monthly average soil temperature at 5 cm depth, and monthly average understory air temp at 1.5 m height.
  2) Relationship between basal area removed and total litterfall and the monthly dynamics of total litterfall in each silvicultural treatment.
  3) Percent of the leaf mass remaining in the litterbags and field litter moisture on the sampling dates throughout 2 years for each treatment.
  4) Nutrient content dynamics in the decomposed litter for each treatment.
  5) Nutrients in the decomposing needles released or absorbed for each treatment.
...
Main Variables of Interest:
  ...
  - Location: Location identified in the "study area and silvicultural treatments" subsection of the "materials and methods" section of the paper. Latitude and longitude provided.
  - Duration: Duration of experiment identified in the materials and methods section, including duration of each phase of the study and time between each litterfall collection.
  - Mass loss: Figure 3 records percent of leaf mass remaining in the litterbags over two years for each silvicultural treatment.
  - Solar Exposure: Forest cover % given in Table 2.
  
Other Variables of Interest:
  - Litter species: Identified in "study area and silvicultural treatments" subsection of "materials and methods" section.
  - Microclimate: Identified in "microclimate" subsection of "materials and methods" section.
  - Litter chemical composition: Identified in Table 4 and 5 (with the latter as nutrient return, and the former as a concentration within only needles and "miscellaneous" litterfall fractions). Nutrient content dynamics in decomposed litter for each treatment identified in Figure 4.
  - Litter bag materials and method: Identified in "Litter decomposition" subsection of "materials and methods" section.
  - Treatments: Identified in "study area and silvicultural treatments" subsection of "materials and methods" section.
  - Age of ecosystem: Mean tree age identified in "study area and silvicultural treatments" subsection of "materials and methods" section.

## Files

These files are in the LadoMonserrat2016 data rescue.

- [Readme](README_LadoMonserrat2016.qmd)
  + This is the primary file that documents the transcriptions and decision made during data rescue.
- [LadoMonserrat2016.bib](LadoMonserrat2016.bib)
  + citation for article transcribed
- [LadoMonserrat2016_Methods.bib](LadoMonserrat2016_Methods.bib)
  + citations for the methods section of the article
- [LadoMonserrat2016_Methods.md](LadoMonserrat2016_Methods.md)
  + methods transcribed from primary article
- [LadoMonserrat2016_TableN.csv](LadoMonserrat2016_TableN.csv)
...
+ Lead
  - [x] Read the article or data resource and the description of the target project
  - [x] Create a fresh fork of the primary repository https://github.com/ktoddbrown/SoilDRaH/tree/main, it might be useful to rename it 'SoilDRaH_LadoMonserrat2016'
  - [x] Create a copy of this template folder and rename it to LadoMonserrat2016
...
+ Do
  ...
  - [ ] Create a spreadsheet with Table4 and export it to csv
...
diff --strip-trailing-cr --suppress-common-lines -y temp/LadoMonserrat2016_FigureM_AC.csv LadoMonserrat2016_FigureM.csv
```
...
diff --strip-trailing-cr --suppress-common-lines -y temp/LadoMonserrat2016_TableN_AC.csv LadoMonserrat2016_TableN.csv
```
...
diff --strip-trailing-cr --suppress-common-lines -y temp/LadoMonserrat2016_Methods_AC.md LadoMonserrat2016_Methods.md
```
